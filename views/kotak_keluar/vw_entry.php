			...
			<div class="container-fluid">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Entry surat keluar</h3>
						<div class="right">
							<button type="button" title="sembunyikan" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
						</div>
					</div>
					<form action="<?php echo site_url('surat_keluar/submit'); ?>" method="post" enctype="multipart/form-data">
...
-->
							...
							<div class="row">
								...
								<div class="col-md-7 col-md-pull-2">
									<input type="text" id="tanggal_terima" name="tanggal_kirim" class="form-control" placeholder="Tanggal terima surat masuk" required>
								</div>
								<div class="col-md-1 col-md-pull-2">
									<i class="fa fa-question-circle fa-1x"></i>
								</div>
