				...
				<div class="panel">
					...
					<div class="panel-heading">
						...
						<table class="table table-condensed" id="table-ah">
							...
							<tbody>
								<?php foreach($row as $k): // echox is custom helper in jovi_helper?>
								<tr>
